...
class AudioCreateForm(forms.ModelForm):
    ...
    description = forms.CharField(widget=forms.TextInput(attrs={
        "type": "description", "name": "description", "class": "form-control"
    }))
    cover = forms.ImageField(widget=forms.FileInput(attrs={
        "type": "file", "name": "cover", "class": "form-control"
    }))
    audio = forms.FileField(widget=forms.FileInput(attrs={
