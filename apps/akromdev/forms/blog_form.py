...
class PostUpdateForm(forms.ModelForm):
    ...
    bg_image = forms.ImageField(required=False, widget=forms.FileInput(attrs={
        "type": "file", "name": "bg_image", "class": "form-control", "placeholder": "Baground image"
    }))
    description = forms.CharField(required=False, widget=forms.TextInput(attrs={
        "type": "text", "name": "description", "class": "form-control", "placeholder": "Description"
    }))
    content = forms.CharField(widget=forms.Textarea(attrs={
        "name": "content", "class": "form-control", "placeholder": "Content"
    }))
