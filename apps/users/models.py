...
class UserAccount(AbstractBaseModel):
    ...
    user = models.ForeignKey("users.User", models.DO_NOTHING, related_name="account", db_index=True)
    ...
    bg_cover = models.ImageField(upload_to="bg/images/%Y/%m/%d", blank=True, null=True, default="bg/default/bg.jpg")
    bio = models.CharField(max_length=300, blank=True, null=True)
    birthday = models.DateField(blank=True, null=True)
    phone_number = PhoneNumberField(blank=True, null=True, region="UZ")
    gender = models.CharField(max_length=1, choices=GENDER_CHOICES, blank=True, null=True)
    country = models.CharField(max_length=50, blank=True, null=True)
    socials = models.ManyToManyField(UserAccountSocialUrl, related_name="user_acccount", db_index=True, blank=True)
